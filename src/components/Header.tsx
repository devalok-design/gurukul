    ...
    <header className="w-full border-b border-surface-border-subtle">
      <div className="max-w-page mx-auto flex items-center justify-between px-ds-06 py-ds-05">
        <Link href="/" className="flex items-center gap-ds-03">
          ...
          <span className="ml-ds-02 inline-flex items-center text-ds-xs font-semibold uppercase tracking-ds-widest text-accent-9 bg-accent-2 border border-accent-5 rounded-pill px-ds-02b py-[1px] leading-none">Alpha</span>
        </Link>
        <Link
          href="/about"
